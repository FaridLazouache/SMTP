...
// Fonctions de gestion des commandes SMTP
...
static inline int dialogue_HELO(FILE *dialogue,char *identification,char *erreur,int taille){
return dialogue_generique(dialogue,"HELO",identification,SUCCES_HELO_CODE,erreur,taille);
}
...
if(dialogue_HELO(dialogue,courriel->hello,erreur,taille)<0) return -1;
